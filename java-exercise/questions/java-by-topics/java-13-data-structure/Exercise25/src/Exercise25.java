...
/**
 * Exercise: Implement push method to insert node to the front of the linked list.
 */
/**
 * Expected Output: Created Linked list is: 1 7 6 4
 */
class Exercise25 { // Linked List
    ...
    public static void main(String[] args) {
        ...
        // 7->6->NUllist
        llist.push(7);
        System.out.println(llist.head.data + " " + llist.head.next.data + " "+ llist.head.next.next);
